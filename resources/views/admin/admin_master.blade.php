...
<body class="fixed-top">
                   ...
                   <ul class="nav top-menu">
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="#">
                                       <span class="photo"><img src="{{asset('public/assets/admin/img/avatar-mini.png')}}" alt="avatar" /></span>
									<span class="subject">
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="{{ url('/category') }}">Add New Category</a></li>
                      <li><a class="" href="{{ url('all-category') }}">View Category</a></li>
                  </ul>
              </li>
              <li class="sub-menu">
                  <a href="javascript:;" class="">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li>
                        <a class="" href="{{url('/General-setting')}}">General Setting</a></li>
   ...
   <script type="text/javascript" src="{{asset('public/assets/admin/assets/uniform/jquery.uniform.min.js')}}"></script>
   <script type="text/javascript" src="{{asset('public/assets/admin/assets/data-tables/jquery.dataTables.js')}}"></script>
   <script type="text/javascript" src="{{asset('public/assets/admin/assets/data-tables/DT_bootstrap.js')}}"></script>
   {{-- <script src="{{asset('public/assets/admin/js/common-scripts.js')}}"></script> --}}
   <script src="{{asset('public/assets/admin/js/dynamic-table.js')}}"></script>
