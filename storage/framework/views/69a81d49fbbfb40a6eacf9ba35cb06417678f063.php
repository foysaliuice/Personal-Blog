         ...
         <div class="widget-body">
             <div class="timeline-messages">
                 ...
                 <div class="msg-time-chat">
                     <a class="message-img" href="#"><img alt="" src="<?php echo e(asset('public/assets/admin/img/avatar1.jpg')); ?>" class="avatar"></a>
                 ...
                 <!-- Comment -->
                 <div class="msg-time-chat">
                     <a class="message-img" href="#"><img alt="" src="<?php echo e(asset('public/assets/admin/img/avatar2.jpg')); ?>" class="avatar"></a>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MyBlog\resources\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>